...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .permitAll()
                .antMatchers(HttpMethod.POST, "/api/auth", "/api/register")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/api/user/current", "/api/user")
                .hasAnyAuthority("ROLE_ADMIN", "ROLE_EDITOR", "ROLE_REVIEWER", "ROLE_USER")
                .antMatchers(HttpMethod.POST, "/api/news/**")
                .hasAnyAuthority("ROLE_ADMIN", "ROLE_EDITOR", "ROLE_REVIEWER")
                .antMatchers(HttpMethod.GET, "/api/users/false", "/api/users/true", "/api/users")
                .hasAuthority("ROLE_ADMIN")
                .antMatchers(HttpMethod.POST, "/api/user/admin")
                .hasAuthority("ROLE_ADMIN")
