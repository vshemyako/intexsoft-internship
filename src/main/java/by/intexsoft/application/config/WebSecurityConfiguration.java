...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/users/false", "/api/users/true", "/api/users").hasAuthority("ROLE_ADMIN")
                .antMatchers(HttpMethod.POST, "/api/user/current", "/api/user").hasAnyAuthority("ROLE_ADMIN", "ROLE_EDITOR", "ROLE_REVIEWER", "ROLE_USER")
